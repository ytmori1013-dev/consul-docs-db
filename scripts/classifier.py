...
CATEGORY_KEYWORDS: dict[str, list[str]] = {
    ...
    "生活・健康": [
        ...
        "栄養", "育児", "子育て", "妊娠", "出産", "結婚", "離婚",
        "家族", "ペット", "猫", "犬", "住宅", "引越し", "インテリア",
        "掃除", "整理整頓", "節約", "家計", "生活費", "便利",
        "ライフハック", "ルーティン", "睡眠", "メンタル", "ストレス",
        "うつ", "マインドフルネス",
    ],
    "グルメ・食": [
        "グルメ", "食べ物", "料理", "レシピ", "食事", "ランチ", "ディナー",
        "朝食", "夕食", "おいしい", "美味しい", "うまい", "ご飯",
        "ラーメン", "寿司", "すし", "焼肉", "カレー", "パスタ", "ピザ",
        "うどん", "そば", "丼", "定食", "弁当", "おつまみ", "スイーツ",
        "ケーキ", "パン", "コーヒー", "お茶", "酒", "ビール", "ワイン",
        "居酒屋", "レストラン", "食堂", "カフェ", "喫茶", "食品",
        "調味料", "産地", "食材", "冷凍食品", "コンビニ飯", "外食",
        "松屋", "吉野家", "すき家", "マクドナルド", "スタバ", "食べログ",
        "ミシュラン", "食中毒", "添加物", "オーガニック", "ヴィーガン",
    ],
}
